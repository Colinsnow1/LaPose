   ...
   <div class="project_detailinfo">
       <table border="1" class="table table-striped table-bordered table-hover">
           ...
           <tr>
              ...
              <td>
              <?php if(is_array($investor_area)): $i = 0; $__LIST__ = $investor_area;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; echo ($vo["area"]); ?>、<?php endforeach; endif; else: echo "" ;endif; ?>
            </td>
           </tr>
